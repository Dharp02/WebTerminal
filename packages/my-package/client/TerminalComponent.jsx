// packages/my-package/client/TerminalComponent.jsx
...
// Original TerminalComponent with Session Persistence and Integrated Container Service
const TerminalComponent = ({ 
  ...
  const endSession = useCallback(async () => {
    ...
    try {
      // If we have container info, call the integrated container service
      if (containerInfo && containerInfo.containerId) {
        if (term.current && show) {
          term.current.writeln('\r\n\x1b[33m→ Ending session and destroying container...\x1b[0m');
        }
        
        // Call integrated container service API to end session
